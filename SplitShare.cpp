...
public:
    ...
    bool addExpense(string& description, double amount, string& paidByUserId,
        ...
        delete strategy; // Clean up memory
...
private:
    ...
    static SplitShare* instance;
    SplitShare() {}
    
public:
    static SplitShare* getInstance() {
        if(instance == nullptr) {
            instance = new SplitShare();
        }
        return instance;
    }
    ...
    // Settlement
    void settleIndividualPayment(const string& fromUserId, const string& toUserId, double amount) {
...
SplitShare* SplitShare::instance = nullptr;

int main() {
    
    cout << "Welcome to SplitShare - Your Smart Expense Splitting App!" << endl;
    cout << "=========================================================" << endl;
    
    SplitShare* manager = SplitShare::getInstance();
    ...
    cout << endl << "=========================================================" << endl;
    cout << "Thank you for using SplitShare!" << endl;
